...
function withoutCertificateWarnings(output) {
    return output
        .split(/\r?\n/)
...
function failureMessage(stdout, stderr, code) {
    return (withoutCertificateWarnings(stderr) ||
...
export function runCliWithStdin(bin, args, prompt, opts = {}) {
